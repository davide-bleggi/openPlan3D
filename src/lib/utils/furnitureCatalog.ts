...
export const furnitureCatalog: FurnitureDef[] = [
  ...
  { id: 'sofa_classic', name: 'Classic Sofa', category: 'Living Room', icon: '🛋️', color: '#a78bfa', width: 190, depth: 85, height: 80 },
  { id: 'sofa_corner', name: 'Corner Sofa', category: 'Living Room', icon: '🛋️', color: '#8b5cf6', width: 240, depth: 220, height: 80 },
  { id: 'sofa_long', name: 'Long Sofa', category: 'Living Room', icon: '🛋️', color: '#a78bfa', width: 240, depth: 90, height: 80 },
  { id: 'sofa_design_corner', name: 'Design Corner Sofa', category: 'Living Room', icon: '🛋️', color: '#c084fc', width: 250, depth: 220, height: 85 },
  { id: 'ottoman', name: 'Ottoman', category: 'Living Room', icon: '🪑', color: '#8b5cf6', width: 80, depth: 60, height: 40 },
  { id: 'chair_design', name: 'Design Chair', category: 'Living Room', icon: '💺', color: '#c084fc', width: 75, depth: 75, height: 85 },
  { id: 'chair_relax', name: 'Relax Lounge Chair', category: 'Living Room', icon: '💺', color: '#a78bfa', width: 90, depth: 100, height: 90 },
  { id: 'chair_cushion', name: 'Cushioned Chair', category: 'Living Room', icon: '💺', color: '#c084fc', width: 80, depth: 80, height: 90 },
  { id: 'chair_modern', name: 'Modern Chair', category: 'Living Room', icon: '💺', color: '#a78bfa', width: 75, depth: 75, height: 85 },
  { id: 'chair_modern_frame', name: 'Modern Frame Chair', category: 'Living Room', icon: '💺', color: '#8b5cf6', width: 75, depth: 75, height: 85 },
  { id: 'chair_rounded', name: 'Rounded Chair', category: 'Living Room', icon: '💺', color: '#c084fc', width: 75, depth: 75, height: 85 },
  { id: 'bench_indoor', name: 'Bench', category: 'Living Room', icon: '🪑', color: '#92400e', width: 120, depth: 40, height: 45 },
  { id: 'bench_cushioned', name: 'Cushioned Bench', category: 'Living Room', icon: '🪑', color: '#a16207', width: 120, depth: 40, height: 45 },
  { id: 'bench_low', name: 'Low Bench', category: 'Living Room', icon: '🪑', color: '#92400e', width: 100, depth: 35, height: 35 },
  { id: 'coffee_table_glass', name: 'Glass Coffee Table', category: 'Living Room', icon: '☕', color: '#94a3b8', width: 120, depth: 60, height: 40 },
  { id: 'coffee_table_glass_square', name: 'Square Glass Coffee Table', category: 'Living Room', icon: '☕', color: '#94a3b8', width: 90, depth: 90, height: 40 },
  { id: 'coffee_table_square', name: 'Square Coffee Table', category: 'Living Room', icon: '☕', color: '#92400e', width: 90, depth: 90, height: 45 },
  { id: 'table_cloth', name: 'Cloth-Covered Table', category: 'Living Room', icon: '🪑', color: '#a16207', width: 100, depth: 60, height: 75 },
  { id: 'table_glass', name: 'Glass Table', category: 'Living Room', icon: '🪑', color: '#94a3b8', width: 120, depth: 70, height: 75 },
  { id: 'table_round', name: 'Round Table', category: 'Living Room', icon: '🪑', color: '#a16207', width: 110, depth: 110, height: 75 },
  { id: 'table_cross_cloth', name: 'Cloth-Covered Cross Table', category: 'Living Room', icon: '🪑', color: '#a16207', width: 100, depth: 60, height: 75 },
  { id: 'side_table_drawers', name: 'Side Table w/ Drawers', category: 'Living Room', icon: '🪑', color: '#a16207', width: 50, depth: 50, height: 55 },
  { id: 'bookshelf_wide', name: 'Wide Bookshelf', category: 'Living Room', icon: '📚', color: '#92400e', width: 160, depth: 30, height: 180 },
  { id: 'bookshelf_low', name: 'Low Bookshelf', category: 'Living Room', icon: '📚', color: '#92400e', width: 80, depth: 30, height: 90 },
  { id: 'tv_stand_doors', name: 'TV Stand w/ Doors', category: 'Living Room', icon: '📺', color: '#475569', width: 150, depth: 45, height: 50 },
  { id: 'television_antenna', name: 'Retro TV w/ Antenna', category: 'Living Room', icon: '📺', color: '#1e293b', width: 70, depth: 45, height: 50 },
  { id: 'television_vintage', name: 'Vintage TV', category: 'Living Room', icon: '📺', color: '#1e293b', width: 60, depth: 45, height: 55 },
  // Bedroom
  ...
  { id: 'bed_bunk', name: 'Bunk Bed', category: 'Bedroom', icon: '🛏️', color: '#60a5fa', width: 100, depth: 200, height: 160 },
  { id: 'cabinet_bed', name: 'Bedside Cabinet', category: 'Bedroom', icon: '🗄️', color: '#a16207', width: 45, depth: 40, height: 50 },
  // Kitchen
  ...
  { id: 'microwave', name: 'Microwave', category: 'Kitchen', icon: '📦', color: '#374151', width: 45, depth: 35, height: 30 },
  { id: 'range_hood', name: 'Range Hood', category: 'Kitchen', icon: '🍳', color: '#94a3b8', width: 80, depth: 45, height: 35 },
  { id: 'range_hood_large', name: 'Large Range Hood', category: 'Kitchen', icon: '🍳', color: '#78716c', width: 90, depth: 50, height: 40 },
  { id: 'kitchen_bar', name: 'Kitchen Bar Counter', category: 'Kitchen', icon: '🔲', color: '#78716c', width: 120, depth: 60, height: 100 },
  { id: 'kitchen_bar_end', name: 'Kitchen Bar Counter End', category: 'Kitchen', icon: '🔲', color: '#78716c', width: 60, depth: 60, height: 100 },
  { id: 'bar_stool', name: 'Bar Stool', category: 'Kitchen', icon: '🪑', color: '#6b7280', width: 35, depth: 35, height: 75 },
  { id: 'bar_stool_square', name: 'Square Bar Stool', category: 'Kitchen', icon: '🪑', color: '#6b7280', width: 35, depth: 35, height: 75 },
  { id: 'cabinet_upper', name: 'Upper Cabinet', category: 'Kitchen', icon: '🗄️', color: '#78716c', width: 60, depth: 35, height: 70 },
  { id: 'cabinet_upper_corner', name: 'Upper Corner Cabinet', category: 'Kitchen', icon: '🗄️', color: '#78716c', width: 60, depth: 60, height: 70 },
  { id: 'cabinet_upper_double', name: 'Upper Double Cabinet', category: 'Kitchen', icon: '🗄️', color: '#78716c', width: 120, depth: 35, height: 70 },
  { id: 'cabinet_upper_low', name: 'Upper Low Cabinet', category: 'Kitchen', icon: '🗄️', color: '#78716c', width: 60, depth: 35, height: 40 },
  { id: 'cabinet_corner_inner', name: 'Inner Corner Cabinet', category: 'Kitchen', icon: '🗄️', color: '#78716c', width: 90, depth: 90, height: 85 },
  { id: 'cabinet_corner_round', name: 'Round Corner Cabinet', category: 'Kitchen', icon: '🗄️', color: '#78716c', width: 90, depth: 90, height: 85 },
  { id: 'fridge_standard', name: 'Standard Fridge', category: 'Kitchen', icon: '🧊', color: '#d1d5db', width: 65, depth: 65, height: 170 },
  { id: 'fridge_built_in', name: 'Built-in Fridge', category: 'Kitchen', icon: '🧊', color: '#d1d5db', width: 60, depth: 60, height: 180 },
  { id: 'fridge_small', name: 'Mini Fridge', category: 'Kitchen', icon: '🧊', color: '#d1d5db', width: 50, depth: 50, height: 85 },
  { id: 'dryer', name: 'Dryer', category: 'Kitchen', icon: '👕', color: '#e2e8f0', width: 60, depth: 65, height: 85 },
  { id: 'washer', name: 'Washer', category: 'Kitchen', icon: '👕', color: '#e2e8f0', width: 60, depth: 65, height: 85 },
  { id: 'blender', name: 'Blender', category: 'Kitchen', icon: '🧃', color: '#94a3b8', width: 20, depth: 20, height: 40 },
  { id: 'coffee_machine', name: 'Coffee Machine', category: 'Kitchen', icon: '☕', color: '#374151', width: 25, depth: 25, height: 35 },
  { id: 'toaster', name: 'Toaster', category: 'Kitchen', icon: '🍞', color: '#9ca3af', width: 25, depth: 20, height: 20 },
  // Bathroom
  ...
  { id: 'shower_round', name: 'Round Shower', category: 'Bathroom', icon: '🚿', color: '#bae6fd', width: 90, depth: 90, height: 210 },
  { id: 'toilet_square', name: 'Square Toilet', category: 'Bathroom', icon: '🚽', color: '#e5e7eb', width: 40, depth: 65, height: 40 },
  { id: 'sink_b_square', name: 'Square Sink', category: 'Bathroom', icon: '🪥', color: '#cbd5e1', width: 60, depth: 45, height: 85 },
  { id: 'bathroom_cabinet', name: 'Bathroom Cabinet', category: 'Bathroom', icon: '🗄️', color: '#cbd5e1', width: 60, depth: 40, height: 85 },
  { id: 'bathroom_cabinet_drawer', name: 'Bathroom Cabinet w/ Drawer', category: 'Bathroom', icon: '🗄️', color: '#cbd5e1', width: 60, depth: 40, height: 85 },
  { id: 'bathroom_mirror', name: 'Bathroom Mirror', category: 'Bathroom', icon: '🪞', color: '#94a3b8', width: 60, depth: 5, height: 70 },
  // Office
  ...
  { id: 'desk_corner', name: 'Corner Desk', category: 'Office', icon: '🖥️', color: '#34d399', width: 140, depth: 140, height: 75 },
  { id: 'laptop', name: 'Laptop', category: 'Office', icon: '💻', color: '#1e293b', width: 35, depth: 25, height: 3 },
  { id: 'computer_monitor', name: 'Monitor', category: 'Office', icon: '🖥️', color: '#1e293b', width: 50, depth: 20, height: 40 },
  { id: 'computer_keyboard', name: 'Keyboard', category: 'Office', icon: '⌨️', color: '#374151', width: 40, depth: 15, height: 3 },
  { id: 'computer_mouse', name: 'Mouse', category: 'Office', icon: '🖱️', color: '#374151', width: 6, depth: 10, height: 3 },
  // Dining
  ...
  { id: 'square_rug', name: 'Square Rug', category: 'Decor', icon: '🟫', color: '#c2956b', width: 200, depth: 200, height: 1 },
  { id: 'rug_rounded', name: 'Rounded Rug', category: 'Decor', icon: '🟫', color: '#b87d5e', width: 200, depth: 300, height: 1 },
  { id: 'doormat', name: 'Doormat', category: 'Decor', icon: '🟫', color: '#a0694e', width: 70, depth: 45, height: 2 },
  { id: 'floor_plant_2', name: 'Floor Plant (Variant 2)', category: 'Decor', icon: '🌿', color: '#22c55e', width: 50, depth: 50, height: 110 },
  { id: 'floor_plant_3', name: 'Floor Plant (Variant 3)', category: 'Decor', icon: '🌿', color: '#22c55e', width: 50, depth: 50, height: 100 },
  { id: 'pillow', name: 'Pillow', category: 'Decor', icon: '🟪', color: '#a78bfa', width: 40, depth: 15, height: 40 },
  { id: 'pillow_blue', name: 'Blue Pillow', category: 'Decor', icon: '🟦', color: '#60a5fa', width: 40, depth: 15, height: 40 },
  { id: 'pillow_long', name: 'Long Pillow', category: 'Decor', icon: '🟪', color: '#a78bfa', width: 55, depth: 15, height: 35 },
  { id: 'pillow_blue_long', name: 'Long Blue Pillow', category: 'Decor', icon: '🟦', color: '#60a5fa', width: 55, depth: 15, height: 35 },
  { id: 'books_stack', name: 'Book Stack', category: 'Decor', icon: '📚', color: '#92400e', width: 30, depth: 20, height: 25 },
  { id: 'coat_rack', name: 'Coat Rack', category: 'Decor', icon: '🧥', color: '#78350f', width: 40, depth: 40, height: 180 },
  { id: 'coat_rack_standing', name: 'Standing Coat Rack', category: 'Decor', icon: '🧥', color: '#78350f', width: 45, depth: 45, height: 180 },
  { id: 'trash_can', name: 'Trash Can', category: 'Decor', icon: '🗑️', color: '#6b7280', width: 30, depth: 30, height: 50 },
  { id: 'cardboard_box', name: 'Cardboard Box', category: 'Decor', icon: '📦', color: '#d4a373', width: 40, depth: 30, height: 30 },
  { id: 'cardboard_box_open', name: 'Open Cardboard Box', category: 'Decor', icon: '📦', color: '#d4a373', width: 40, depth: 30, height: 30 },
  { id: 'teddy_bear', name: 'Teddy Bear', category: 'Decor', icon: '🧸', color: '#a16207', width: 25, depth: 20, height: 35 },
  { id: 'radio', name: 'Radio', category: 'Decor', icon: '📻', color: '#374151', width: 30, depth: 15, height: 20 },
  { id: 'speaker', name: 'Speaker', category: 'Decor', icon: '🔊', color: '#1e293b', width: 25, depth: 25, height: 40 },
  { id: 'speaker_small', name: 'Small Speaker', category: 'Decor', icon: '🔊', color: '#1e293b', width: 15, depth: 15, height: 25 },
  // Lighting
  ...
  { id: 'floor_lamp_square', name: 'Square Floor Lamp', category: 'Lighting', icon: '🪔', color: '#e5e7eb', width: 40, depth: 40, height: 160 },
  { id: 'table_lamp_square', name: 'Square Table Lamp', category: 'Lighting', icon: '💡', color: '#fde68a', width: 25, depth: 25, height: 45 },
  { id: 'ceiling_fan_3d', name: 'Ceiling Fan', category: 'Lighting', icon: '🌀', color: '#e5e7eb', width: 100, depth: 100, height: 30 },
  ...
  { id: 'stairs', name: 'Decorative Stairs', category: 'Structures', icon: '🪜', color: '#a16207', width: 100, depth: 300, height: 180 },
  { id: 'stairs_corner', name: 'Decorative Corner Stairs', category: 'Structures', icon: '🪜', color: '#a16207', width: 150, depth: 150, height: 180 },
  { id: 'stairs_open', name: 'Decorative Open Stairs', category: 'Structures', icon: '🪜', color: '#a16207', width: 100, depth: 300, height: 180 },
  { id: 'stairs_open_single', name: 'Decorative Open Single-Rail Stairs', category: 'Structures', icon: '🪜', color: '#a16207', width: 80, depth: 300, height: 180 },
